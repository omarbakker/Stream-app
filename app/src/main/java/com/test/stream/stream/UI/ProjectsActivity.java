...
import com.test.stream.stream.Utilities.UserManager;
...
public class ProjectsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton addProjectButton = (FloatingActionButton) findViewById(addProjectButton);
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("Projects Page") // TODO: Define a title for the content shown.
