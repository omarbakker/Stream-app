...
public class BoardManager {
    ...
    public void InitializePins(Context context) //Note: Change context to your activity class & do it for the private functions
    {
        registerBoard(context);
    }

    //Assumes a project exists.
    private void registerBoard(final Context context)
    {
        ...
        ChildEventListener listener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                if(dataSnapshot.exists())
                {
                    ...
                    CreateMessagePin("testTitle", "testSubTitle", "testDescription");
    ...
    private void registerPins(Context context)
    {
    ...
    private void registerPins(final String pinId, final Context context)
    {
